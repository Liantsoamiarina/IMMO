<div class="container py-4">
    ...
    <div class="d-flex gap-2 flex-wrap mb-4">
        <button class="btn btn-warning fw-bold text-white">Sort Price ↓</button>
        ...
        <button class="btn btn-warning fw-bold text-white"><i class="fa fa-plus"></i> Add Property</button>
    </div>
